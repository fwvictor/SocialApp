...
class TwitterLoginActivity : AppCompatActivity() {
    ...
    private fun showLoginOk() {
        Snackbar.make(
            findViewById(android.R.id.content), getString(R.string.login_twitter_successfully),
    ...
    private fun showLogoutOk() {
        Snackbar.make(
            findViewById(android.R.id.content), getString(R.string.logout_twitter_successfully),
            Snackbar.LENGTH_LONG
        ).show()
    }
